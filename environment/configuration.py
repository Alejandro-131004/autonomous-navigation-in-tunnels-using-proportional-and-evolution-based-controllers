...
STAGE_DEFINITIONS = {
    ...
    5: {'num_curves': 1, 'angle_range': (0, 10), 'num_obstacles': 1, 'obstacle_types': ['wall']},
    6: {'num_curves': 2, 'angle_range': (20, 30), 'num_obstacles': 1, 'obstacle_types': ['wall']},
    7: {'num_curves': 2, 'angle_range': (30, 40), 'num_obstacles': 1, 'obstacle_types': ['wall']},
    8: {'num_curves': 2, 'angle_range': (40, 50), 'num_obstacles': 1, 'obstacle_types': ['wall']},
    9: {'num_curves': 2, 'angle_range': (50, 60), 'num_obstacles': 2, 'obstacle_types': ['wall']},
    10: {'num_curves': 3, 'angle_range': (60, 70), 'num_obstacles': 2, 'obstacle_types': ['wall']},
    11: {'num_curves': 3, 'angle_range': (70, 80), 'num_obstacles': 2, 'obstacle_types': ['wall']},
    12: {'num_curves': 3, 'angle_range': (80, 90), 'num_obstacles': 2, 'obstacle_types': ['wall']},
    13: {'num_curves': 4, 'angle_range': (90, 100), 'num_obstacles': 2, 'obstacle_types': ['wall']},
    14: {'num_curves': 4, 'angle_range': (100, 110), 'num_obstacles': 2, 'obstacle_types': ['wall']},
    15: {'num_curves': 4, 'angle_range': (100, 110), 'num_obstacles': 3, 'obstacle_types': ['wall']},
    16: {'num_curves': 4, 'angle_range': (110, 120), 'num_obstacles': 3, 'obstacle_types': ['wall']},
    17: {'num_curves': 4, 'angle_range': (120, 130), 'num_obstacles': 3, 'obstacle_types': ['wall']},
