# -*- coding: utf-8 -*-
"""evaluation/analyze_population_performance.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1E88qjmXnDxbhzWB9TywrqKoxSRCfdKIc
"""
...
def evaluate_population_performance(checkpoint_path, num_maps_per_stage=5):
    ...
    em todas as fases de dificuldade disponíveis.
    """
    ...
    # Estrutura para guardar os resultados: {stage_id: [fitness_ind_1, fitness_ind_2, ...]}
    results = defaultdict(list)
    stages_to_evaluate = sorted(map_pool.keys())
...
def plot_performance_heatmap(results, stages, num_individuals):
    ...
    fig, ax = plt.subplots(figsize=(max(12, len(stages) * 0.6), max(8, num_individuals * 0.3)))
...
if __name__ == '__main__':
    try:
        if len(sys.argv) > 1:
            ...
            checkpoint_path = input("Por favor, introduza o caminho para o ficheiro de checkpoint (.pkl) que deseja analisar: > ")
