...
class Individual:
    def __init__(self, distP=None, angleP=None, id=None):
        ...
        self.distP = distP if distP is not None else random.uniform(0.5, 5.0)
        self.angleP = angleP if angleP is not None else random.uniform(0.1, 2.0)
    ...
    def mutate(self, mutation_rate=0.1, mutation_strength=0.5):
        ...
        self.distP = np.clip(self.distP, 0.1, 10.0)
